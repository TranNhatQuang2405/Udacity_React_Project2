...
const percentVoted = (question = {}, option) => {
    ...
    let divied = (totalVotedOption / (totalVoted === 0 ? 1 : totalVoted) * 100) || 0
    return divied.toFixed(0)
}

function QuestionOptionDetail({ questionInfo, optionId, isVoted, answer, setPending }) {
    ...
    return (
        <div className={answer === optionId ? "QuestionOptionDetail__option active" : "QuestionOptionDetail__option"}>
            ...
            </div>
            {
                isVoted ? (
                    <div className="QuestionOptionDetail__boxDetail">
                        <div>{`${totalAnswerByOption(questionInfo, optionId)} persons voted this option`}</div>
            ...
            {
                answer === optionId && <div className="QuestionOptionDetail__markChosen">You have chosen this</div>
            }
